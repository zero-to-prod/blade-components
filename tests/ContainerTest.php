...
class ContainerTest extends TestCase
{
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-7xl">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <header class="mx-auto px-4 max-w-7xl">foo</header>
            HTML;

        $this->assertComponentRenders($expected, '<x-container tag="header">foo</x-container>');
    }
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-0">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-none">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-xs">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-sm">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-md">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-lg">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-xl">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-2xl">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-3xl">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-4xl">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-5xl">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-6xl">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-full">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-min">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-max">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-fit">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-prose">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-screen-sm">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-screen-md">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-screen-lg">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-screen-xl">foo</div>
            HTML;
    ...
    {
        $expected = <<<'HTML'
            <div class="mx-auto px-4 max-w-screen-2xl">foo</div>
            HTML;
